...
<link rel="stylesheet"
	href="/Gather/vendors/ti-icons/css/themify-icons.css">
<link rel="stylesheet" href="/Gather/vendors/css/vendor.bundle.base.css">
<!-- endinject -->
<!-- Plugin css for this page -->
<link rel="stylesheet"
	href="/Gather/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
<link rel="stylesheet"
	href="/Gather/vendors/ti-icons/css/themify-icons.css">
<link rel="stylesheet" type="text/css"
	href="/Gather/js/select.dataTables.min.css">
<!-- End plugin css for this page -->
<!-- inject:css -->
<link rel="stylesheet"
	href="/Gather/css/vertical-layout-light/style.css">
<!-- endinject -->
...
<body>
	...
	<div class="container-scroller">
					...
					<li class="nav-item"><a class="nav-link"
						...
						<div class="collapse" id="ui-basic">
							<ul class="nav flex-column sub-menu">
								...
								<li class="nav-item"><a class="nav-link" href="./addMember">新增會員</a></li>
							</ul>
						</div></li>
					<li class="nav-item"><a class="nav-link"
      ...
      <!--性別比 圓餅圖-->
		...
		<script
			src="/Gather/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
		...
		<script>
			//第一個是女生 第二男生
			setMaleFemale(${statisticsMember[0]},${statisticsMember[1]});
		</script>
