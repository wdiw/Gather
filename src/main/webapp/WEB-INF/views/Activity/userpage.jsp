...
.warp1{width:100%;white-space:normal;word-wrap:break-word;word-break:break-all;}
</style>
</head>
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					...
					<li class="nav-item"><a class="nav-link"
						data-toggle="collapse" href="<spring:url value='/Activity/selectall' />" aria-expanded="false"
										...
										<table class="table table-hover" >
											...
											<c:forEach items='${activities}' var='activity' >
												<tr>
													...
													<td><div class="warp">${activity.description}</div></td>
