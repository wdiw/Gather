			...
			<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
				...
				<body class="goto-here">
						...
						<div class="container" id="navBarTop">
							...
							<div class="collapse navbar-collapse" id="ftco-nav">
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item"><a href="<spring:url value='/memberactivitylogin' />"
						...
						<div class="container">
							<div class="row no-gutters slider-text align-items-center justify-content-center">
								<div class="col-md-9 ftco-animate text-center">
									...
									<h1 class="mb-0 bread">Gather抽獎活動</h1>
							...
							<div class="col text-center">
								<div class="block-27">
									<div style="text-align: center;">
										<img src="images\ok.png" class="js-img-ok" width="200px" height="200px" />
										<img src="images\shake.gif" class="js-img-shake" width="200px" height="200px" />
										<h1>Gather歡慶官網開幕線上抽獎活動</h1>
										<input type="text" id="js-result" name='lotteryesult'>
										<button id="js-start" class="btn btn-primary py-3 px-4">開抽！</button>
									</div>
									<button class="btn btn-primary py-3 px-4" id='return'>返回</button>
								</div>
							</div>
						</div>
						</div>
					...
					<script>
						...
						var data = ['蘿琳亞塑身衣一件', '龜甲萬甘甜醬油一瓶', '娘家滴雞精一盒', 'Iphone13'];
						var random = Math.floor(Math.random() * data.length);
                        var activityParticipation="${activityParticipationBean}"
						var activityParticipationid="${activityParticipationBean.membername}"
							...
							$('#return').show();}
								...
								Swal.fire({
										...
										if (result.isConfirmed) {
											...
											location.href = "<spring:url value='/activitylogin?id=13'/>";
										}
									})
                        ...
                        $('#return').click(function(){
							...
							var lotteryresult=$('#js-result').val();
						
						
							$.ajax({
					
								url: "<spring:url value='/lotteryresult'/>",
								type: "Get",
								data: { lotteryresult: lotteryresult },//前面是標籤，後面是值
								success: function (data) {
								
									Swal.fire({
										title: '完成抽獎活動！',
										icon: 'success',
										text:'恭喜您獲得:'+lotteryresult,
									}).then((result) => {
										if (result.isConfirmed) {
