										...
										<div class="panel panel-default">
											<div class="panel-heading" role="tab" id="headingOne">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">活動分類
													</a>
												</h4>
											</div>
											<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
												<div class="panel-body">
													<ul>
														...
														<li><a href="<spring:url value='/actvityCategory?category=優惠活動' />" >優惠活動</a></li>
														<li><a href="<spring:url value='/actvityCategory?category=課程講座' />">課程講座</a></li>
														<li><a href="<spring:url value='/actvityCategory?category=提案競賽' />">提案競賽</a></li>
														<li><a href="<spring:url value='/actvityCategory?category=線上抽獎' />">線上抽獎</a></li>
