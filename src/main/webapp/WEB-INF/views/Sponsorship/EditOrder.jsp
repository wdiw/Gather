...
<html lang="en">
    			...
    			<div class="col-md-12 ftco-animate">
                  ...
                  <form  id="form" class="forms-sample">
                    ...
                    <i class="mdi mdi-nutrition"></i>
                      <label for='sID'>方案名稱</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                    <div class="form-group">
                    <i class="mdi mdi-account-star"></i> 
                       <label for='sID'>贊助方案</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                    <div class="form-group">
                    <i class="mdi mdi-counter"></i>
                       <label for='sID'>贊助人</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                    <div class="form-group">
                    <i class="mdi mdi-book"></i>
                      <label for='sID'>連絡電話</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                    <div class="form-group">
                    <i class="mdi mdi-coin"></i>
                      <label for='sID'>寄送地址</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                  
                    <div class="form-group">
                    <i class="mdi mdi-coin"></i>
                      <label for='sID'>贊助金額</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                  
                    <div class="form-group">
                    <i class="mdi mdi-coin"></i>
                      <label for='sID'>付款方式</label>
                      <input name="sID" id="sID" class="form-control" value="${sBean.sID}" readonly="readonly">
                    </div>
                    <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Gather <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
  ...
  <script>
		$(document).ready(function(){
			...
			alert("${sessionScope.memberData.id}");
		var quantitiy=0;
