<%@page import="com.Gather.member.entity.Member"%>
...
<!-- 		              </a> -->
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">${categoryresult.postTime}</a></div>
		                  <div><a href="#">${categoryresult.poster}</a></div>
<!-- 		                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div> -->
		                </div>
		                <h3 class="heading"><a href="<c:url value='/postdetail?id=${categoryresult.id}' />">[${categoryresult.postCategory}] ${categoryresult.name}</a></h3>
		                <!-- 文章內容顯示有問題 -->
<%-- 		                <p style="width:400px; white-space:nowrap;overflow: hidden; text-overflow:ellipsis; ">${forum.post}</p> --%>
		                <p>..........</p>
		                <p><a href="<c:url value='/postdetail?id=${categoryresult.id}' />	" class="btn btn-primary py-2 px-3">Read more</a></p>
		              </div>
		            </div>
		          </div>
		          </c:forEach>
