...
<!--                 </span> -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <table class="table table-hover">
		...
		<c:forEach items='${categoryResult}' var='categoryresult' >
			<tr>
				<td>
				<a href="<c:url value='/Forum/detail?id=${categoryresult.id}' />" style="color:black;" >${categoryresult.id}</a>
<%-- 				缺分類${forum.id} --%>
				</td>
				<td>
				<a href="<c:url value='/Forum/detail?id=${categoryresult.id}' />" style="color:black;" >${categoryresult.postCategory}</a>
				</td>
				<td style="">
...
<%-- 					${forum.name} --%>
						<a href="<c:url value='/Forum/detail?id=${categoryresult.id}' />" style="color:black;" >${categoryresult.name}</a>
					</div>
				</td>
...
<!-- 					<button onclick="init()">TEST</button> -->
				...
				<td>
				${categoryresult.poster}<br>
				${categoryresult.postTime}
				</td>
				<td>${categoryresult.postUpdateTime}</td>
				<td>回覆數123</td>
<!-- 				<td> -->
