							...
							<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
								<div class="product d-flex flex-column">
									<a href="<c:url value='/showProject/${project.pID}' />"
										...
										src="/Gather/${project.pImageCover}" alt=""> <!-- <span class="status">50% Off</span> -->
									...
									<div class="text py-3 pb-4 px-3">
										...
										<h3>
											<a href="<c:url value='/showProject/${project.pID}' />">${project.pName}</a>
										</h3>
										<div class="pricing">
											<p class="price">
												<!-- <span class="mr-2 price-dc"></span> -->
												<span class="price-sale">目標金額:NT$${project.pTarget}</span>
											</p>
										</div>
										...
										<div class="pricing">
											<p class="price">
												<!-- <span class="mr-2 price-dc"></span> -->
												<span class="price-sale">累積贊助:NT$${project.pAmountNow}</span>
											</p>
										</div>
										<p></p>
										<div class="container">
