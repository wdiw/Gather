								...
								<div class="row d-flex mb-5 contact-info">
										...
										<div class="carousel-testimony owl-carousel ftco-animate" style="padding: 0%;">
											<div class="item">
												<div class="testimony-wrap">
													<a href="#changeUserPhoto" class="btn btn-inverse-success btn-fw "
														data-toggle="modal"
									...
									<div class="col-md-3 d-flex">
										<div class="info bg-white p-4" style="font-size: 30px;">
											<h2><b>會員設定</b></h2>
											<a href="#changePassword" class="btn btn-inverse-success btn-fw"
								...
								<div class="modal-content" style="padding: 15%;text-align: center;">
									...
									<div class="form-group" style="margin-top:10px ;">
										<img style="position: relative;border: 2px burlywood solid;border-radius: 50%;"
											src="/Gather/images/Members/${memberData.id}.jpg" width="350" height="300"
											alt="請選擇照片" id="showPic" class="img-rounded">
									</div>
									<form action="upload" method="post" enctype="multipart/form-data" class="pt-3">
										<div class="form-group">
											選擇圖片:
											<input type="file" name="file" accept="image/*"
												class="form-control form-control-lg" id="memberImage" />
										</div>
										<div class="mt-3">
						...
						<div id="changePassword" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content" style="padding: 15%;">
									...
									<div class="form-group">
										Current Password<input type="password" id="text_old_password"
											class="form-control form-control-lg">
									</div>
									<div class="form-group">
										New Password<input type="password" id="text_new_password"
											class="form-control form-control-lg">
									</div>
									<div class="form-group">
										Retry Password<input type="password" id="text_check_password"
											class="form-control form-control-lg">
									</div>
									<div class="mt-3">
